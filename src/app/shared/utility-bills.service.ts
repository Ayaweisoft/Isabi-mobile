...
export class UtilityBillsService {
  ...
  servicePrefix = "/v2/utility-bills";
  ...
  getBanks() {
    ...
    return this.http.get(
      environment.apiBaseUrl + this.servicePrefix + "/banks"
    );
  }
  ...
  getLeaderboard(week: number, year: number) {
    return this.http.get(
      environment.apiBaseUrl +
        `/get-weekly-leaderboard/?week=${week}&year=${year}`
    );
  }
  ...
  updateLeaderboardCount(data) {
    return this.http.post(
      environment.apiBaseUrl + "/update-leaderboard-count",
      data
    );
  }
  ...
  getMoreLeaderboard(limit: any, skip: any, week: any, year: any) {
    return this.http.get(
      environment.apiBaseUrl +
        `/get-weekly-leaderboard/?limit=${limit}&skip=${skip}&week=${week}&year=${year}`
    );
  }

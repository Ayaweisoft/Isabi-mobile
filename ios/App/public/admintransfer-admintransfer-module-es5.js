(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["admintransfer-admintransfer-module"], {
    ...
    /***/
    function node_modulesRawLoaderDistCjsJsSrcAppAdmintransferAdmintransferPageHtml(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppAdmintransferAdmintransferModuleTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "AdmintransferPageModule", function () {
        return AdmintransferPageModule;
      });
      /* harmony import */
      ...
      var _admintransfer_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ./admintransfer.page */
      ...
      var AdmintransferPageModule = function AdmintransferPageModule() {
        _classCallCheck(this, AdmintransferPageModule);
      };

      AdmintransferPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
    ...
    /***/
    function srcAppAdmintransferAdmintransferPageScss(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppAdmintransferAdmintransferPageTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "AdmintransferPage", function () {
        return AdmintransferPage;
      });
      /* harmony import */
      ...
      var AdmintransferPage = /*#__PURE__*/function () {
        function AdmintransferPage(accountService, toastController, alertController, popoverController) {
          _classCallCheck(this, AdmintransferPage);
        ...
        _createClass(AdmintransferPage, [{
          key: "ngOnInit",
          value: function ngOnInit() {}
        }, {
          key: "getManualList",
          value: function getManualList() {
            var _this = this;

            this.accountService.getManualTransactions().subscribe(function (res) {
              _this.loading = false;
              _this.manualTransfer = res['trans'];
              console.log(_this.manualTransfer);
            });
          }
        }, {
          key: "confirmUser",
          value: function confirmUser(id) {
            var _this2 = this;

            this.loading = true;
            console.log(id);
            this.accountService.confirmTransaction(id).subscribe(function (res) {
              _this2.loading = false;

              _this2.getManualList();
            }, function (err) {
              _this2.loading = false;
              console.log(err);
          ...
          key: "declineAlert",
          value: function declineAlert(id, amount, username) {
                  ...
                  switch (_context2.prev = _context2.next) {
                    case 0:
                      ...
                      return this.alertController.create({
                        ...
                        message: "Message <strong> ".concat(amount, "</strong>!!! <br>\n              Username : ").concat(username),
                        buttons: [{
                          text: 'CANCEL',
                          role: 'cancel',
                          cssClass: 'secondary',
                          ...
                          handler: function handler() {
                            ...
                            _this3.accountService.declineTransaction(id).subscribe(function (res) {
                              var message = 'Transaction declined';
                              console.log(res);

                              _this3.getManualList();

                              _this3.presentToast(message);
                            }, function (err) {
      ...
      AdmintransferPage.ctorParameters = function () {
        return [{
      ...
      AdmintransferPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
        selector: 'app-admintransfer',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
        /*! raw-loader!./admintransfer.page.html */
        "./node_modules/raw-loader/dist/cjs.js!./src/app/admintransfer/admintransfer.page.html"))["default"],
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
        /*! ./admintransfer.page.scss */
        "./src/app/admintransfer/admintransfer.page.scss"))["default"]]
      })], AdmintransferPage);
      /***/
    }
  }]);
})();
//# sourceMappingURL=admintransfer-admintransfer-module-es5.js.map